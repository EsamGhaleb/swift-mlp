...
def read_stop_function_words():
   ...
   most_common_words = pd.read_excel('lex_code/data/SUBTLEX-NL.cd-3SDsmean.xlsx')  
   ...
   function_words = [] 
   with open('lex_code/data/cabb_input/function_words.txt', encoding="ISO-8859-1") as f:
      lines = f.readlines()
   for word in lines:
      word = word.split("\n")[0]
